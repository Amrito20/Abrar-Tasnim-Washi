...
// Contact functionality (no form needed)
...
function loadSkills() {
    const technicalSkills = [
        { name: 'ANSYS', icon: 'fas fa-cogs', description: 'Advanced CFD Analysis' },
        ...
        { name: 'Microsoft Office', icon: 'fas fa-file-alt', description: 'Documentation & Presentation' }
    ];
    
    const softSkills = [
        { name: 'Creativity', icon: 'fas fa-lightbulb', description: 'Innovative Problem Solving' },
        ...
        { name: 'Teamwork', icon: 'fas fa-users', description: 'Collaborative Work' },
        { name: 'Critical Thinking', icon: 'fas fa-brain', description: 'Analytical Approach' },
        { name: 'Meeting Deadlines', icon: 'fas fa-clock', description: 'Time Management' }
    ];
...
console.log('💼 Abrar Tasnim Washi - Mechanical Engineering Student');
